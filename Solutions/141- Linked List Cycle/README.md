...
## Solutions
There is a trick that you should know. you consider two pointers. one slow, one fast. the fast increments twice as much as the other one. if these two pointers meet each other, then there is a cycle in the linked list. otherwise, there is no cycle in the linked list.