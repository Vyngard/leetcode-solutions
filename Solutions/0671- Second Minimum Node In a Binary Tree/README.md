...
## Solutions
in this binary tree, the root always has the minimum value, so you need to check the rest of the tree for the second minimum value. for that matter, you can use a depth-first search to traverse the tree and find the second minimum value.