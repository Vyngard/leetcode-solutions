...
## Solutions
first you use `group by` to find the numbers that happened only once. Then you use `max` to find the largest number among them. if there isn't any, it will automatically return `null` as the result.
