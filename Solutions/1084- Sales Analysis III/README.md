...
## Solutions
first you find out the `product_id` that are outside the range of `2019-01-01` and `2019-03-31` and then you can use `NOT IN` to find the requested products. remeber to use `DISTINCT` to avoid duplicates.