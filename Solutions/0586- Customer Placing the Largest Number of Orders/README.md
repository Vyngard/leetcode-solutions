...
## Solutions
first you use `group by` to make a group of `customer_number`. the you use `order by` based on the `count` of `order_number` in descending order. then you use `limit 1` to get the first row of the result.
