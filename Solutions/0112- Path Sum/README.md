...
## Solutions
It's easy. you should do the DFS search. for each node, reduce the target sum by the value of the node and when you reach the leaf check if the target sum is 0.