...
## Solutions
You can use `Left Join` to solve this problem. The `Left Join` will return all the rows from the left table and the matched rows from the right table. If there is no match, the result is NULL from the right side. 