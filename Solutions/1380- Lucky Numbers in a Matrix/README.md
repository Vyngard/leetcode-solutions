...
## Solutions
you can create a set. in that you keep the minimum of each row. then you start finding the max of each column. if the max of the column is in the set then you add it to the result. if it is not in the set then you continue. 