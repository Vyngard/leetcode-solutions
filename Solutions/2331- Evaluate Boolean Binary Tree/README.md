...
## Solutions
it is easy. you just use recursion to solve this problem. if the node is a leaf node, return the value of the node. otherwise, evaluate the node's two children and apply the boolean operation of its value with the children's evaluations.