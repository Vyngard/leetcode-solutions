...
## Solutions
you can use two pointers. the first pointer is at the start of the word. the second one is at the index of the `ch`. then you can reverse the characters between the two pointers until the meet each other.