...
## Solutions
Since we know that the maximum frequency of an element is at most 100, we can use an array to store the frequency of each element. Then we can find the maximum frequency and count the number of elements that have the maximum frequency.
