...
## Solutions
even though it is easy, i think it is a good question to practice the usage of `sorted` function in python and java. watch [this video](https://www.youtube.com/watch?v=Evq1SfUbhBg) to learn more about the usage of `sorted` function in python.